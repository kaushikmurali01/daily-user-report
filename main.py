...
cur = conn.cursor()
cur.execute("""
    SELECT u.first_name, u.last_name, u.email, u.phonenumber, u."createdAt", c.company_name
    FROM epp.users u
    JOIN epp.user_company_role ucr ON u.id = ucr.user_id
    JOIN epp.company c ON ucr.company_id = c.id
